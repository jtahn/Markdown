...
- important for writing 'correct' solutions
	- determine what time and space complexity i'll assume for sorting
		- then any time i see a writeup that says 'depends on sorting algo', i can replace that with the actual complexity
		- actually nah; there's a variety and some have different time/space complexities...
		- probly just be aware that time can generally be assumed nlogn, and space O(1)...

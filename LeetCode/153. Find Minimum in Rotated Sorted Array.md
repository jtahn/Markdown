...
- keep code for different variants
	- while loop’s exit conditions
	- 2 vs 3 cases
	- bisect module

- move to ‘binary search’
	- "# future remark"
	- long explanation/details, but in a more general form
...
- ok imo i need to have a massive blurb on binary search where i move these observations...dont change wording to be general, just label/cite which problems i made these observations; make connections once i feel comfy



- binary search for 2 cases:
	- how do we decide which half to throw away?

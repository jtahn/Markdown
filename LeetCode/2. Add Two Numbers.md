...
- the two techniques should be under same heading
...
- what is this ‘memory leak’ discussion?
...
- keep the 'int-to-list' trick, but i highly suspect its python only
...
- imo remove chain assignment
	- this is way too python specific
	- this should just become an anki 'debug the code' type card
	- there's no way there is a fp for this...bc chain assignment is just a trick to combine lines of code
	- btw meta: these type of cards:

...
## 2 pointer
- there: i should mention that before you can apply this technique, you often first need to 'define/characterize solution as an extreme value'
...
## iterate better; skip iterations

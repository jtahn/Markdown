...
- [[_refs/02 algorithms/clrs.pdf#page=349&selection=294,0,510,1|clrs, page 349]]
	- trie = radix tree
- [[_refs/01 competitive programming/halim2.pdf#page=74|halim2, 6.5 Suffix Trie/Tree/Array]]
	- suffix trie/tree/array are all different structures used to store 'all suffixes in a dictionary'
- [[_refs/02 algorithms/skiena.pdf#page=460|skiena, 15.3 Suffix Trees and Arrays]]
...
- [[_refs/02 algorithms/sedgewick.pdf#page=745&annotation=4526R|sedgewick, page 745]]
	- trie = type of search tree
- [[../_refs/02 algorithms/kt.pdf|kt]] has no discussion
- [[../_refs/02 algorithms/dpv.pdf|dpv]] has no discussion

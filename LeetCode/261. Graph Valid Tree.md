...
- bg
	- [skiena 8.1.3](../_refs/algorithms/skiena.pdf#page=264)
		- - [skiena union find data structure](../_refs/algorithms/skiena.pdf#page=470&selection=34,0,76,49)
	- [DSU/Union Find Fundamentals](https://algo.monster/problems/dsu_intro)
	- clrs
		- [dynamic sets](../_refs/algorithms/clrs.pdf#page=271)
		- [disjoint sets](../_refs/algorithms/clrs.pdf#page=542)
		- [disjoint-set forest](../_refs/algorithms/clrs.pdf#page=549)
			- aka implementation via trees
		- [kruskal's algo](../_refs/algorithms/clrs.pdf#page=613)

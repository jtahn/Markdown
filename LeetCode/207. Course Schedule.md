...
- reference
	- [[_refs/texts/adm.pdf#page=244|adm, 7.10 Depth-First Search on Directed Graphs]]
...
- [epi explanation of dfs algo](../_refs/texts/epi.pdf#page=369&offset=-115,625,0)
...
- for the kahn algo:
	- background about in/outdegrees:
		- [degree](../_refs/texts/clrs.pdf#page=1187&selection=139,0,139,6)
		- [top sort](../_refs/texts/clrs.pdf#page=595&selection=8,0,8,4)

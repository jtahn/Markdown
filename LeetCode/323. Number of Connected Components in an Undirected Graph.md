...
- but note:
	- the way you're provided the graph is just a list of the edges
	- It's not like an adjacency list structure or matrix
- so dfs just feels very inefficient here


- todo:
	- delete the dfs solution for now
	- later explain why union-find is conceptually better
	- imo it has to do with the input...bc its just a straight up list of the edges

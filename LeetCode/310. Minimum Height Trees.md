...
- in general, this is a hard problem
	...
	- [[_refs/02 algorithms/skiena.pdf#page=386|skiena, 11.6 The Art of Proving Hardness]]
	- [[_refs/01 competitive programming/halim2.pdf#page=182|halim2, 8.6.5 Longest-Path]]
- specific situations with efficient algos
	- dag: critical path
		- [[_refs/02 algorithms/clrs.pdf#page=641&selection=44,66,115,10|clrs, page 641]]
		- [[_refs/02 algorithms/skiena.pdf#page=545&selection=36,0,59,9|skiena, page 545]]
		- [[_refs/01 competitive programming/halim1.pdf#page=279&selection=141,0,154,17|halim1, page 279]]
	- tree
		- [[_refs/01 competitive programming/halim2.pdf#page=182&selection=171,0,171,21|halim2, page 182]]
...
- finding diameter
	- general graph
		- [[_refs/01 competitive programming/halim1.pdf#page=276&selection=9,0,9,31|halim1, page 276]]
	- (weighted) tree
		- [[_refs/01 competitive programming/halim1.pdf#page=286&selection=146,0,146,27|halim1, page 286]]
			- 2x dfs or bfs
		- [[_refs/02 algorithms/clrs.pdf#page=585&selection=212,0,276,79|clrs, page 585]]
...
- refs
	- [[_refs/01 competitive programming/halim1.pdf#page=231&selection=115,0,115,16|halim1, page 231]]
...
- another way to see why its based on degrees:
	...
	- ![[../!assets/attachments/Pasted image 20240528174043.png]]

...
- you can use 3 case
	- bc timestamps are unique and provided in strictly increasing order
...
- for either 2 or 3 case: need to clearly explain:
...
- at the bottom:
	- keep code for defaultdict and bisect
	- move discussion to fundamental problem
		- fp for default dict: include factory functions:
			- int
		- defaultdict should also discuss, what the default value is for the builtin factory functions
			- ie int is 0
